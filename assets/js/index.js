...
// отримати масив пошт користувачів
const userEmails = userArray1.map(function (user, i) {
  return user.email;
});

// отримати масив повнолітніх користувачів
const adultUsers = userArray1.filter(function (user) {
  return user.age >= 18;
});

// отримати масив повнолітніх чоловіків без підписки
const resultArray = userArray1.filter(function (user) {
