...
/*
  створити форму з інпутом у кнопою додати
  при кожному сабміті даних з форми створювати нову тудушку

  * за допомогою JS перевірте що в інпуті не надали погану задачу
    (будь-яка задача не може починатися з пробілу або просто пустий рядка )
*/